          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="glass-card p-8 rounded-2xl mb-8 text-left">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h2 className="text-xl font-semibold">Common Reasons for Cancellation</h2>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-electric-400 rounded-full mt-2"></div>
                  <p className="text-white/70">Insufficient funds or card limit reached</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 rounded-xl">
              ...
              <div className="space-y-2 text-left text-sm text-white/70">
                <div className="flex items-start space-x-2">
                  <span>•</span>
                  <span>Ensure your card has sufficient funds and international payments are enabled</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span>•</span>
                  <span>Try using a different browser or clearing your cache</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span>•</span>
                  <span>Disable ad blockers or VPN services that might interfere</span>
                </div>
                <div className="flex items-start space-x-2">
                  <span>•</span>
                  <span>Contact your bank if the payment is being blocked</span>
                </div>
              </div>
            </div>
          </div>
