...
import { CheckCircle, Download, ArrowRight, Mail, Calendar, ExternalLink } from 'lucide-react';
...
export default function PaymentSuccess() {
  ...
  useEffect(() => {
    const fetchOrderDetails = async () => {
      if (sessionId) {
        try {
          // In production, fetch actual order details from your API
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="glass-card p-4 rounded-xl">
                ...
                <Button asChild className="btn-secondary w-full text-sm">
